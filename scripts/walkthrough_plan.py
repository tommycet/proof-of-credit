"""
Walkthrough plan for Proof of Credit (Python native — no JS exec).

Records the dApp as a real user would use it. Per-stage speed regions
compress consensus waits while keeping all flows visible.
"""
